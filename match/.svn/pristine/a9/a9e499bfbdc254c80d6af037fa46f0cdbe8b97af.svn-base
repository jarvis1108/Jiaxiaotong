...
CREATE TABLE `bd_progress_task`  (
  ...
  `have_score` tinyint(3) NOT NULL DEFAULT 0 COMMENT '是否得分 0: 得分 1：不得分',
  ...
  `is_deleted` tinyint(3) NOT NULL DEFAULT 0 COMMENT '逻辑删除 0：未删除 1：已删除',
  `task_type` int(11) NOT NULL DEFAULT 0 COMMENT '任务类型 0：经典背诵 1：视频导读 2：品读(纯文本) 3：品读(有音频文件，用户可以点读，默读) 4：品读(用户需要朗读,语音识别) 6：总结与拓展',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `bd_question`  (
  ...
  `question_type` tinyint(3) NOT NULL DEFAULT 0 COMMENT '题目类型 0：选择题 1：判断题 2：多选题 3：简答题 4：填空题',
...
CREATE TABLE `bd_redeem`  (
  ...
  `manager_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '发放管理员id',
  `saler_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '发放给对应推销员的id',
...
CREATE TABLE `ub_progress_study`  (
  ...
  `progress_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '进度id',
  `periods_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程班级id',
  `recite_status` tinyint(3) NOT NULL DEFAULT 0 COMMENT '背诵状态 0：未开始 1：背诵完成',
  `recite_score` int(11) NOT NULL DEFAULT 0 COMMENT '背诵得分',
  `recite_record` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '背诵录音地址',
  `read_status` tinyint(3) NOT NULL DEFAULT 0 COMMENT '阅读状态 0：未开始 1：未完成 2：已完成',
...
CREATE TABLE `ub_user_promotion_follow`  (
  ...
  `user_be_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '被邀请用户id',
...
CREATE TABLE `uc_user`  (
  ...
  `user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户名 当用户来源不为用户名密码注册时，此项可为空',
  `user_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户编号',
  `user_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户昵称',
  `user_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户登录密码 当用户手机号注册、微信来源，此项可为空',
  ...
  `user_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户手机号 当用户来源为用户名密码注册、公众号时，此项为空',
  `user_origin` tinyint(3) NOT NULL DEFAULT 0 COMMENT '用户来源 0 用户名密码注册 1 手机号注册 2 公众号来源 3 小程序来源',
  `wechat_user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '当用户来源为公众号和小程序时，此项关联微信第三方信息',
