/** @file
 * @description <br/> //  ******************************************************************
 *              <br/> //  * 功能说明：最强学霸接口设计_私有题库修改选择题
 *              <br/> //  * 创建标志：林航 2018年09月08日创建
 *              <br/> //  * 修改标志：
 *              <br/> //  * 标志编号：
 *              <br/> //  * 标志描述：
 *              <br/> //  * 附注说明：
...
function QFL_CHO_010() {
    ...
    /**
     * @summary 实现功能：用户修改私有题库某一选择题
     * @description PUT /api/v1/question/questionForLib/updateChoice/{questionForLibId}      //questionForLibId为题目id

     * @param {object} objParam                                        要传入的参数
     * @param {string} objParam.reqId                                  要传入的参数.请求的Id
     * @param {string} objParam.reqType                                要传入的参数.请求类型 固定值为: QFL_CHO_040_updateChoice
     ...
     * @example 暂无
     */
    function updateChoice(objParam) {
        var objResult = {};
        return objResult;
    }
}