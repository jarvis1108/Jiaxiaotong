...
function OMT_CMC_010()
{
     ...
     * @param {string} objParam.reqType                                要传入的参数.请求类型 固定值为: OMT_CMC_010_getSpecialTrainingMembers
     ...
     * @param {object} objParam                                        要传入的参数
     * @param {string} objParam.reqId                                  要传入的参数.请求的Id
     * @param {string} objParam.reqType                                要传入的参数.请求类型 固定值为: OMT_CMC_010_addNewMember
     * @param {object} objParam.reqParam                               要传入的参数.请求的业务参数
     ...
     * @param {string} objResult.reqType                                             返回结果.请求类型
     * @param {Object} objResult.resResult                                           返回结果.响应返回的业务数据
     * @param {array} objResult.resResult.membersVO                                  返回结果.响应返回的业务数据.训练营成员VO视图列表
     * @param {array} objResult.resResult.membersVO                                  返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员
     * @param {string} objResult.resResult.membersVO.userID                          返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户Id
     * @param {string} objResult.resResult.membersVO.wechatName                      返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户微信名
     * @param {string} objResult.resResult.membersVO.lastUserId                      返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户父节点Id
     * @param {string} objResult.resResult.membersVO.communityRoleId                 返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户在社区中的角色Id
     * @param {string} objResult.resResult.membersVO.treeNodeCode                    返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户的树形结点Id
     * @param {Byte} objResult.resResult.membersVO.isLeafNode                        返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户是否是叶子节点
     * @param {string} objResult.resResult.membersVO.communityRoleName               返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户在社区中的角色名
     * @param {string} objResult.resResult.membersVO.level                           返回结果.响应返回的业务数据.训练营成员VO视图列表第i个成员.用户在社区的等级
     * @version 1.0
     * @example 暂无
     */
