 ...
 */
@Entity
@Table(name = "t_SYS_UserCoinDetail")
public class UserCoinDetail {
    private String userCoinDetailId;//用户金币明细ID
    private String userCoinDetailNo;//用户金币明细编码
    private String userId;//用户ID
    private String userNo;//用户编码
    private Timestamp occurTime;//业务发生时间
    private Integer originalAmount;//初始金币数量
    private Integer acquiredAmount;//获取金币数量
    private Integer lossAmount;//损失金币数量
    private Integer currentAmount;//当前金币数量
    ...
    @Id
    @Column(name = "UserCoinDetailID")
    public String getUserCoinDetailId() {
        return userCoinDetailId;
    }

    public void setUserCoinDetailId(String userCoinDetailId) {
        this.userCoinDetailId = userCoinDetailId;
    }

    @Basic
    @Column(name = "UserCoinDetailNo")
    public String getUserCoinDetailNo() {
        return userCoinDetailNo;
    }

    public void setUserCoinDetailNo(String userCoinDetailNo) {
        this.userCoinDetailNo = userCoinDetailNo;
    }
    ...
    public String toString() {
        return "UserCoinDetail{" +
                "userCoinDetailId='" + userCoinDetailId + '\'' +
                ", userCoinDetailNo='" + userCoinDetailNo + '\'' +
                ", userId='" + userId + '\'' +
                ", userNo='" + userNo + '\'' +
                ", occurTime=" + occurTime +
