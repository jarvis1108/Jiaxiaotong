...
<div class="st-battle-ready-container">
  <img class="st-battle-ready-bg" src="/static/images/battleReady/Matching_bg.png"/>

  <!-- user -->
  <div class="st-battle-ready-user-div">
    <div class="st-battle-ready-user-img">
      <img class="st-battle-ready-meteor" src="/static/images/battleReady/Meteor1_bg.png"/>
      <img class="st-battle-ready-user-icon" :src="userInfo.headImage"/>
    </div>
    <img class="st-battle-ready-user-line" src="/static/images/battleReady/Dottedline2.png" />
  ...
  <img class="st-battle-ready-vs" src="/static/images/battleReady/vs.png"/>

  <div class="st-battle-ready-opponent-div">
    <div class="st-battle-ready-opponent-img">
      <img class="st-battle-ready-meteor" src="/static/images/battleReady/Meteor2_bg.png"/>
      <img class="st-battle-ready-opponent-icon" :src="opponentInfo.headImage"/>
    </div>
    <img class="st-battle-ready-opponent-line" src="/static/images/battleReady/Dottedline1.png" />
