 ...
 * @description                              
 */
function MAL_RHG_030() {

    /**
     * @summary 实现功能：获取用户充值记录
     * @description **GET** /api/v1/mall/orderRecord/list
     * @param {object} objParam                                        要传入的参数
     * @param {string} objParam.reqId                                  要传入的参数.请求的ID
     * @param {string} objParam.reqType                                要传入的参数.请求类型 固定值为: MAL_CHG_030_GetRechangeRecordList
     ...
     * @example 暂无
     */
    function GetRechangeRecordList(objParam) {
        var objResult = {};
        return objResult;
    }
}