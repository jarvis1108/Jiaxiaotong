/** @file
 * @description <br/> //  ******************************************************************
 *              <br/> //  * 功能说明：最强学霸接口设计_后台管理 得到扫码验证url
 *              <br/> //  * 创建标志：林航 2018年11月25日创建
 *              <br/> //  * 修改标志：
 *              <br/> //  * 标志编号：
 *              <br/> //  * 标志描述：
 *              <br/> //  * 附注说明：
 ...
 */
 ...
 /**
 * @class
 * @summary 实现功能：后台管理 获得扫码验证url
 * @memberOf QFL
 * @description                
 */
function BAM_QRL_010() {

    /**
     * @summary 实现功能：后台管理 获得扫码验证url
     * @description POST /api/v1/bam/qrCodeLogin/getAuthUrl

     * @param {object} objParam                                        要传入的参数
     * @param {string} objParam.reqId                                  要传入的参数.请求的Id
     * @param {string} objParam.reqType                                要传入的参数.请求类型 固定值为: BAM_QRL_010_getAuthUrl
