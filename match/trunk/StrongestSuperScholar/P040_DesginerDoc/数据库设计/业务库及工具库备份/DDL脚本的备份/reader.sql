...
CREATE TABLE `ub_advice`  (
  ...
  `advice_describe` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '意见反馈',
  `advice_reply` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '意见反馈回复',
...
CREATE TABLE `ub_study_question`  (
  ...
  `answer_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '回答内容（上传图片，存储的是图片链接List）',
  `answer_key` int(11) NULL DEFAULT 0 COMMENT '选项key{选择题{0,1,2,3表示用户选的是第几个选项}和判断题【0是正确，1是错误】}',
...
CREATE TABLE `uc_user`  (
  ...
  `is_deleted` tinyint(3) NOT NULL DEFAULT 0 COMMENT '逻辑删除 0：未删除 1：已删除',
  `user_wechat_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户微信号',
  PRIMARY KEY (`Id`) USING BTREE
