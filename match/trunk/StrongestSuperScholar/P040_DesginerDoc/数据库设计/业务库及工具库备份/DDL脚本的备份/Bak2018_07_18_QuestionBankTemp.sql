...
CREATE TABLE `t_ITN_Subject`  (
  ...
  `OrderIndex` int(11) NULL DEFAULT NULL COMMENT '导入序号',
  `TreeCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '大纲序号',
