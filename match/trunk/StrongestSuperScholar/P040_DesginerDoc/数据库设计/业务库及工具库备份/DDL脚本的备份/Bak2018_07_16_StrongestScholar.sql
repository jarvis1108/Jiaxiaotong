...
BEGIN 
  ...
  DECLARE cur CURSOR FOR 
	SELECT  `T1`.`SubjectID` AS `SubjectID`,
					...
					`T1`.`Remark` AS `Remark` 
	FROM QuestionBankManual.Dvlp_v_Init_Subject3 T1
  ...
  DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
	...
	-- 2.检验及预处理	
	Set In_Str_InitID = IFNULL(In_Str_InitID,'01cd58b1-88a2-11e8-a7b0-5254009bf409');
